...
export default function Home() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-between p-8 bg-gradient-to-br from-slate-900 via-stone-500 to-slate-900 text-white">
            <div className="flex-1 flex flex-col items-center justify-center text-center">
                <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-lime-400 to-purple-400 bg-clip-text text-transparent">
                    {message}
                </h1>
